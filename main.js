...
// Push-to-Talk: mantén presionado para hablar
// =============================================
...
function stopPressToTalk() {
    ...
    // Detener el reconocimiento (esto procesa lo que se dijo)
    stopListening();
}
